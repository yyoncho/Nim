...
function HEX5BHEX5D_721421620(s_721421623, x_721421624) {
  var result_721421625 = [];

    var a_721421627 = x_721421624.a;
    var L_721421629 = addInt(subInt(subInt((s_721421623).length, x_721421624.b), a_721421627), 1);
    result_721421625 = nimCopy(null, mnewString(chckRange(L_721421629, 0, 2147483647)), NTI33554449);
    Label1: {
      var i_721421634 = 0;
      var i_553649389 = 0;
      Label2: {
          Label3: while (true) {
          if (!(i_553649389 < L_721421629)) break Label3;
            i_721421634 = i_553649389;
            result_721421625[chckIndx(i_721421634, 0, (result_721421625).length - 1)] = s_721421623[chckIndx(addInt(i_721421634, a_721421627), 0, (s_721421623).length - 1)];
            i_553649389 = addInt(i_553649389, 1);
          }
      };
    };

  return result_721421625;
...
async function loadIndex_553649054() {
  ...
  BeforeRet: {
    ...
    var rootURL_553649088 = HEX5BHEX5D_721421620(cstrToNimstr(indexURL_553649062), HEX2EHEX2E_956301416(0, 14));
