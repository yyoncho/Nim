...
var NTI33555190 = {size: 0, kind: 17, base: null, node: null, finalizer: null};
...
var NNI33555190 = {kind: 2, len: 0, offset: 0, typ: null, name: null, sons: []};
NTI33555190.node = NNI33555190;
NTI33555190.base = NTI33555180;
NTI989855748.base = NTI33555190;
...
function reprEnum(e_33557599, typ_33557600) {
  var result_33557601 = [];
  ...
  framePtr = F;
    ...
    var tmp_33557602 = false;
    F.line = 31;
    var item_33557603 = typ_33557600.node.sons[e_33557599];
    F.line = 32;
    tmp_33557602 = item_33557603 !== undefined
    if (tmp_33557602) {
    F.line = 34;
    result_33557601 = nimCopy(null, makeNimstrLit(item_33557603.name), NTI33554449);
    }
    else {
      F.line = 36;
      result_33557601 = nimCopy(null, (HEX24_369098760(e_33557599) || []).concat([32,40,105,110,118,97,108,105,100,32,100,97,116,97,33,41] || []), NTI33554449);
    }
    
  framePtr = F.prev;

  return result_33557601;
